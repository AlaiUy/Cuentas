...
Public Class frmBonificacionInco
    ...
    Private Function getMovimientoFromPendientes(ByVal xSerie As String, ByVal xNumero As Integer, ByVal xPosicion As Integer) As Movimiento
        For Each M As MovimientoGeneral In _Movimientos
    ...
    Private Sub btnBonificar_Click(sender As Object, e As EventArgs) Handles btnBonificar.Click
        ...
        Try
            ...
            GCobros.getInstance().BonificarInco(ObtenerSeleccionados(), _Cliente, cbMonedas.SelectedItem, 0, Nothing, txtComentario.Text, chkImprimir.Checked)
    ...
    Private Sub tbimporte_KeyDown(sender As Object, e As KeyEventArgs)
        If e.KeyCode = 188 Then
            e.Handled = True
        End If
    End Sub

    Private Sub tbimporte_KeyPress(sender As Object, e As KeyPressEventArgs)
        If e.KeyChar = "," Then
            e.Handled = True
            SendKeys.Send(".")
            Return
    ...
    Private Sub tbimporte_TextChanged(sender As Object, e As EventArgs)
